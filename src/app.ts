...
function initializeGame() {
    ...
    const numMineInput = document.getElementById("mine-count") as HTMLInputElement;
...
function toggleFlag(target: HTMLDivElement, row: number, col: number) {
...
function revealCell(row: number, col: number) {
    ...
    cell.revealed = true;
    const cellDiv = <HTMLElement> document.querySelector(`.cell[data-row="${row}"][data-col="${col}"]`)!;
    cellDiv.classList.add("revealed");
